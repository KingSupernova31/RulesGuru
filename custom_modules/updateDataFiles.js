...
//All counters, and then a bunch of split card names and a few others that are words someone might want to use. All of these (except the list of counters) have actually been problems in the past, so don't remove them without good reason.
