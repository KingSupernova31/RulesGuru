...
bindButtonAction(
	...
	function () {
		...
		httpRequest.onabort = function () {
			document.getElementById("cursorStyle").innerHTML = "";
			alert(
				"There was an error updating the citation(s). (Request aborted.) Please check your internet connection and try again. If the problem persists, please report the issue.",
			);
		};
		httpRequest.onerror = function () {
			document.getElementById("cursorStyle").innerHTML = "";
			alert(
				"There was an unknown error updating the citation(s). Please check your internet connection and try again. If the problem persists, please report the issue.",
			);
		};
		httpRequest.ontimeout = function () {
			document.getElementById("cursorStyle").innerHTML = "";
			alert(
				"There was an error updating the citation(s). (Request timed out.) Please check your internet connection and try again. If the problem persists, please report the issue.",
			);
		};
		httpRequest.onLoad = function () {
		...
		const removeCitationsInput = document.getElementById(
			"removeCitationsInput",
		);
		const requestObj = {
			toAdd: addCitationsInput.value,
			toRemove: removeCitationsInput.value,
		};
		httpRequest.open("POST", "/updateCitations", true);
		httpRequest.setRequestHeader("Content-Type", "application/json");
		httpRequest.send(JSON.stringify(requestObj));
