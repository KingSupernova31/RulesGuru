...
//Mobile browsers sometimes "helpfully" zoom out when the page size changes, like when the sidebar opens, so the minimum scale prevents that. No maximum because we still want the user to be able to zoom in manually.
